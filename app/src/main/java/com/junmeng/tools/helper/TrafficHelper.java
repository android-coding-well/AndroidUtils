...
import static com.junmeng.tools.utils.net.NetUtil.getActiveNetworkInfo;
...
public class TrafficHelper {
	...
	public static TrafficHelper getInstance(Context context) {
		...
		TrafficHelper.isWifi=isWifiValid(context);
	...
	public  void updateData() {
		if (uid!= -1) {
			...
			boolean flag = isCurrentDay(getTrafficDateDay());
			boolean flag2 = isCurrentMonth(getTrafficDateDay());
