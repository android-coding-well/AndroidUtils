package com.junmeng.tools.utils.date;
...
public class DateUtil {
     ...
     * @return
     */
    public static String getDescriptionTimeFromTimestamp2(@NonNull String dateStr) {
        long timestamp = dateStrToTimestamp(dateStr);
        if (timestamp != 0) {
            return getDescriptionTimeFromTimestamp2(timestamp);
        }
     ...
     * @return
     */
    public static String timestampToDateStr(long timestamp, @NonNull String pattern) {
        String sd = "";
        try {
